...
class StorageManager:
    ...
    @staticmethod
    def upload_image(file_path, folder="datacalonrw"):
        """
    ...
    @staticmethod
    def update_image(old_firebase_path, new_file_path, folder="datacalonrw"):
        """
    ...
    # data calonrt
    @staticmethod
    def upload_image(file_path, folder="datacalonrt"):
        """
        Upload image to Firebase Storage
        """
        try:
    ...
    @staticmethod
    def update_image(old_firebase_path, new_file_path, folder="datacalonrt"):
        """
        Update image in Firebase Storage
        """
        try:
